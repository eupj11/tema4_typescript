...
(function (MiGeometria) {
    ...
    MiGeometria.FormaGeometrica = FormaGeometrica;
    ...
    MiGeometria.Triangulo = Triangulo;
})(MiGeometria || (MiGeometria = {}));
var cuadrado = new MiGeometria.Cuadrado("Rojo", 0.3, "Cuadrado", 12);
cuadrado.mostrarCuadrado();
var circulo = new MiGeometria.Circulo("Amarillo", 0.1, "Círculo", 10, 20);
circulo.mostrarCirculo();
var triangulo = new MiGeometria.Triangulo("Naranja", 0.5, "Triángulo", 3, 5.5);
